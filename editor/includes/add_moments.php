      ...
      <div class="form-grid">
        <div id="w-node-_7a260c29-eaea-38ca-7dd7-75753354bfb4-f1521fbf" data-w-id="7a260c29-eaea-38ca-7dd7-75753354bfb4" style="opacity:1" class="form-con-wrappera">
          <div class="form-container">
            <div class="form-title">Add new moments</div>
            <div class="w-form">
              <form id="appointment-form" method="post" action="includes/add_new_moments.php" enctype="multipart/form-data" class="form">
                <div class="field-container">
                  ...
                  <div class="field-wrapper">
                    ...
                    <input type="file" class="" name="moments" accept="image/*;capture=camera" id="">
                  </div>
                </div>
                ...
                <div data-w-id="5b8a60ca-0674-a70c-a128-7036f4b41cbe" class="button rounded-button">
                  ...
                  <button class="button-link w-button" name="add_moments" id="add_moments">Add this moments</button>
                </div>
              </form>
