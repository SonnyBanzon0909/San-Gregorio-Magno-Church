      ...
      <div class="form-grid">
        <div id="w-node-_7a260c29-eaea-38ca-7dd7-75753354bfb4-f1521fbf" data-w-id="7a260c29-eaea-38ca-7dd7-75753354bfb4" style="opacity:1" class="form-con-wrappera">
          <div class="form-container">
            ...
            <div class="w-form">
              <form id="appointment-form" method="post" action="includes/update_new_announcement.php" enctype="multipart/form-data" class="form">
                <div class="field-container">
                  ...
                  <div class="field-wrapper">
                    ...
                    <input type="file" class="" name="announcement" id="announcement" accept="image/*;capture=camera" id="">
                  </div>
                  <div class="field-wrapper">
                    <label>Name</label>
                ...
                <div data-w-id="5b8a60ca-0674-a70c-a128-7036f4b41cbe" class="button rounded-button">
                  ...
                  <button class="button-link w-button" name="update_announcement" id="update_announcement">Update</button>
                </div>
              </form>
