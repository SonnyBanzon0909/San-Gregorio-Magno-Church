      ...
      <div class="form-grid">
        <div id="w-node-_7a260c29-eaea-38ca-7dd7-75753354bfb4-f1521fbf" data-w-id="7a260c29-eaea-38ca-7dd7-75753354bfb4" style="opacity:1" class="form-con-wrappera">
          <div class="form-container">
            <div class="form-title">Add new announcement</div>
            <div class="w-form">
              <form id="appointment-form" method="post" action="includes/add_new_announcement.php" enctype="multipart/form-data" class="form">
                ...
                <div data-w-id="5b8a60ca-0674-a70c-a128-7036f4b41cbe" class="button rounded-button">
                  ...
                  <button class="button-link w-button" name="add_announcement" id="add_announcement">Add this announcement</button>
                </div>
              </form>
