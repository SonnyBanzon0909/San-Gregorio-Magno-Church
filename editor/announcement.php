...
<head>
  ...
  <body>
    ...
    switch($source){
      ...
      include "includes/view_announcement.php";
      break;

      case 'update_announcement';
      include "includes/update_announcement.php";
      break;

      default:
      include "includes/announcement_list.php";
      break;
    }
...
// Loop through all the remove-pic elements and add an event listener to each one
    ...
    {
    xhttp.open('GET', '/editor/includes/delete-announcement.php?id=' + id, true); // Replace  
    xhttp.send();
