...
<head>
  ...
  <body>
    ...
    switch($source){
      case 'add_priest';
      include "includes/add_priest.php";
      break;

      case 'view_priest';
      include "includes/view_priest.php";
      break;

      case 'update_priest';
      include "includes/update_priest.php";
      break;

      default:
      include "includes/priests_list.php";
      break;
    }
 ...
 // Loop through all the remove-pic elements and add an event listener to each one
    ...
    {
    xhttp.open('GET', '/editor/includes/delete-priests.php?id=' + id, true); // Replace  
    xhttp.send();
