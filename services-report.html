...
<html data-wf-page="643128f5637d393818beab1a" data-wf-site="640c46a109bfca551c61da47">
<head>
  <meta charset="utf-8">
  <title>Services - Report</title>
  <meta content="Services - Report" property="og:title">
  <meta content="Services - Report" property="twitter:title">
...
.border-bot-right, .border-top-left
{
  ...
  <div class="section status-section wf-section">
    <div class="container">
      <div id="w-node-e11252ee-d72a-90fa-2d26-73bcf10fd970-18beab1a" class="w-form">
        <form method="get" name="email-form" data-name="Email Form" style="opacity:0" data-w-id="e11252ee-d72a-90fa-2d26-73bcf10fd971" id="email-form" class="filter-wrapper">
          <div id="w-node-_80536e23-6151-9975-adb2-35980bf7c7b0-18beab1a" class="select-filter-wrapper">
            ...
            <div class="select-wrapper"><select id="month" name="Month" data-name="Month" class="select filter-select w-select">
              ...
              </select><img src="images/down-chevron-1.svg" loading="lazy" alt="" class="select-icon"></div><input type="text" class="select filter-select w-node-bf108295-d0aa-8c11-e91e-2270fbecb533-18beab1a w-input" maxlength="256" name="Year" data-name="Year" placeholder="Select year" id="year">
          ...
          <div id="w-node-b4028a5b-c8ef-df80-9a35-75789bf105b1-18beab1a" class="search-wrapper">
            <div id="w-node-b6ec6774-df05-e803-8d15-82867510d761-18beab1a" class="print-wrapper">
              <div id="w-node-_797a341e-e77b-3edb-abfc-8ecd7d3a3407-18beab1a" class="print-con dl-con"><img src="images/Mask-group.svg" loading="lazy" alt="" class="print-icon"></div>
              <div id="w-node-_707b0ddf-b844-fdc1-5875-afad95fc28e2-18beab1a" class="print-con printer-con"><img src="images/Mask-group-1.svg" loading="lazy" alt="" class="print-icon"></div>
            </div>
            <div id="w-node-_4cca64a6-0a55-4a6e-5412-4a46426bcb02-18beab1a" class="input-wrapper">
...
s0.parentNode.insertBefore(s1,s0);
  ...
  <div class="section login-section sign-in-section wf-section">
    <div class="login-wrapper">
      ...
      <div class="form-block w-form">
        <form id="wf-form-login" name="wf-form-login" data-name="login" method="get" class="login-form display-block">
          <div id="w-node-_55624acf-f15f-fc5e-8f62-de9f34de7e8b-34de7e81" class="not-save-wrapper">
            <div class="input-con"><input type="email" class="input-field w-input" maxlength="256" name="login-email-3" data-name="Login Email 3" placeholder="Email" id="login-email-3"></div>
            <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="login-password-3" data-name="Login Password 3" placeholder="Password" id="login-password-3"></div>
          </div>
    ...
    <div class="otp-wrapper">
      ...
      <div class="code-wrapper">
        ...
        <div class="code-pin-wrapper w-embed">
          <div class="code-con">
            <input type="text" placeholder="0" id="code1" class="code">
            <input type="text" placeholder="0" id="code2" class="code">
            <input type="text" placeholder="0" id="code3" class="code">
            <input type="text" placeholder="0" id="code4" class="code">
          </div>
        </div>
  ...
  <div class="section login-section create-section wf-section">
    <div class="login-wrapper">
      <a data-w-id="b6a4babc-5026-d4af-ff01-fe6645157765" href="#" class="close-login w-inline-block"><img src="images/close-icon-2.svg" loading="lazy" alt="" class="close-icon"></a>
      <div class="login-title-wrapper"><img src="images/parokya-ni-San-Gregorio-Magno.png" loading="lazy" alt="" class="login-logo">
        <div class="text-block">Create Account</div>
      </div>
      <div class="w-form">
        <form id="wf-form-login" name="wf-form-login" data-name="login" method="get" class="login-form">
          <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="Full-Name-3" data-name="Full Name 3" placeholder="Full Name" id="Full-Name-3"></div>
          <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="Birthday-2" data-name="Birthday 2" placeholder="Birthday" id="Birthday-2"><img src="images/calendar-2.svg" loading="lazy" alt="" class="calendar"></div>
          <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="Contact-number-2" data-name="Contact Number 2" placeholder="Contact number" id="Contact-number-2"></div>
          <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="Address-3" data-name="Address 3" placeholder="Address" id="Address-3"></div>
          <div class="select-wrapper"><select id="barangay-2" name="barangay-2" data-name="Barangay 2" class="select login-select w-select">
              <option value="">Choose your barangay</option>
              <option value="Brgy. Aguado">Brgy. Aguado</option>
              <option value="Brgy. Inocencio">Brgy. Inocencio</option>
            </select><img src="images/down-chevron.svg" loading="lazy" alt="" class="select-icon"></div>
          <div class="input-con"><input type="email" class="input-field w-input" maxlength="256" name="Email-2" data-name="Email 2" placeholder="Email" id="Email-2"></div>
          <div class="input-con"><input type="text" class="input-field w-input" maxlength="256" name="Create-password-3" data-name="Create Password 3" placeholder="Create password" id="Create-password-3"></div>
          ...
          <div data-w-id="b6a4babc-5026-d4af-ff01-fe6645157781" class="button rounded-button">
            <div class="button-overlay"></div><input type="submit" value="SIGN UP" data-wait="Please wait..." class="button-link w-button">
          </div>
        </form>
        <div class="w-form-done">
