...
try {
    ...
    $mail->Password   = 'parokyan_admin2023';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('admin@parokya-ni-san-gregorio-magno.com', 'Mailer');
    $mail->addAddress('sonnybanzon090997@gmail.com', 'Joe User');     //Add a recipient
    $mail->addAddress('sonnybanzon090997@gmail.com');               //Name is optional
    $mail->addReplyTo('admin@parokya-ni-san-gregorio-magno.com', 'Information');
