  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="abt-sticky-wrapper"><img src="images/parokya.jpg" loading="lazy" style="opacity:0" data-w-id="eaf2cd15-34f9-fd39-1d3f-e92771dc1e75" alt="" class="parokya-img">
          <div data-w-id="55009323-918f-1a08-2812-cfa3a29a3eb1" style="opacity:0" class="abt-content-wrapper">
            ...
            <div class="rich-text-block w-richtext justify" style="line-height: 28px; letter-spacing:0 ;">
    ...
    <div class="section vision-section wf-section">
      <div class="container">
        ...
        <div data-w-id="7041dab3-be42-2241-181e-19a005849583" style="opacity:0" class="body-text-medium vision-excerpt max-135 justify"><?php echo $vision_content; ?>
        ...
        <div data-w-id="a1767852-ec39-07a3-96c2-a3e77e30d7b8" style="opacity:0" class="body-text-medium vision-excerpt max-135 justify"><?php echo $mission_content; ?>
