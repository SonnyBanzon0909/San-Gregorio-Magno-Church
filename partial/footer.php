...
<div class="section login-section edit-section wf-section" id="edit-sign-section">
  <div class="login-wrapper">
    ...
    <div class="login-title-wrapper">
      <div class="edit-logo-wrapper"><img src="http://parokya-ni-san-gregorio-magno.com/images/images/<?php $photo; ?>" loading="lazy" id="logo" alt="" class="login-logo edit-logo">
