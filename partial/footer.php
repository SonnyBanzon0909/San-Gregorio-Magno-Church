  ...
  <div class="login-wrapper">
    ...
    <div class="w-form">
      <form id="create-forms" name="wf-form-login" data-name="login" method="post" class="login-form"action="" onsubmit="return create()"  >
        ...
        <div class="input-con">
          <input required type="text" class="input-field w-input create-field" maxlength="256" name="c-birthday" data-name="Birthday 2" placeholder="Birthday" id="c-birthday" min="<?= date('Y-m-d') ?>">
...
<script type="text/javascript">
  ...
  $("#c-birthday").click(function(){
    ...
    document.getElementById("c-birthday").setAttribute("min", today);
  });
