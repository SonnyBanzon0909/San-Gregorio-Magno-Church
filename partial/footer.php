  ...
  <div class="section login-section create-section wf-section">
    <div class="login-wrapper">
      ...
      <div class="w-form">
        <form id="create-forms" name="wf-form-login" data-name="login" method="post" class="login-form" action="create-account.php" >
          ...
          <div class="input-con"><input required type="text" class="input-field w-input create-field" maxlength="256" name="c-contact" data-name="Contact Number 2" placeholder="Contact number" id="c-contact"></div>
          ...
          <div data-w-id="b6a4babc-5026-d4af-ff01-fe6645157781" class="button rounded-button" >
            <div class="button-overlay"></div><input type="submit" value="SIGN UP" data-wait="Please wait..." class="button-link w-button create-btn">
